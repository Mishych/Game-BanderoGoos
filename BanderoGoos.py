...
pygame.init()
pygame.mixer.init()
pygame.mixer.music.load("kordhell_-_live_another_day_muzati.net.mp3")
pygame.mixer.music.play(-1)

explosion_sound_1 = pygame.mixer.Sound("boevoy-vzryiv.wav")
explosion_sound_2 = pygame.mixer.Sound("katastroficheskiy-spontannyiy-vzryiv-snaryada.wav")
explosion_sound_3 = pygame.mixer.Sound("aa4b773936bb0cb.mp3")
game_over_sound = pygame.mixer.Sound("provalil-igru-pohoronnyi-marsh.mp3")
...
def create_boss():
    boss = pygame.transform.scale(pygame.image.load('pngwing.com (4).png'), (300, 260)).convert_alpha()
...
def create_bonus():
    bonus = pygame.transform.scale(pygame.image.load('bonus.png'), (200, 150)).convert_alpha()
